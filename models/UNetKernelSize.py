...
class UNetKernelSize(nn.Module):
    def __init__(self, in_channels, num_classes, kernel_size=3):
        ...
        self.bottle_neck = DoubleConv(512, 1024, kernel_size=kernel_size)

        self.up_convolution_1 = UpSample(1024, 512, kernel_size=kernel_size)
        self.up_convolution_2 = UpSample(512, 256, kernel_size=kernel_size)
        self.up_convolution_3 = UpSample(256, 128, kernel_size=kernel_size)
        self.up_convolution_4 = UpSample(128, 64, kernel_size=kernel_size)
